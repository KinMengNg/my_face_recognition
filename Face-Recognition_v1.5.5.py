...
Expected Distance: '''))
    ...
    #previous_encodings = [] #come together with the locations, holds the highest confidence from last iteration for each face
        ...
        for face_location in locations:
            ...
            if found_flag == False:
               ...
               #the lower the scorer the 'closer' the encoding is to the known encoding, thus higher confidence, vice versa
                ...
                face_encoding = (face_recognition.face_encodings(small_image, [face_location]))[0] #it returns a list, of 1 element, so i take the first
                #print(face_encoding)
