...
New Distance: '''))
    ...
    for face_encoding, face_location in zip(encodings, locations):
        ...
        if True in results:  # If at least one is true, get a name of first of found labels
            ...
            pil_image.save('known_faces_pic/{}_Pic/{}-{}.jpg'.format(match, match, timestamp))


            #UPDATING THE DATABASE IMMEDIATELY
            name = input("Who's face does ID {} belong to? Press ENTER to skip this ID: ".format(match))
            ...
            for encoding in os.listdir('{}/{}'.format(ENCODINGS_DIR, match)): #just putting folder doesnt seem to work
                ...
                if name == '':
                    ...
                    if name in os.listdir(ENCODINGS_DIR):
                        ...
                        shutil.copy('{}/{}_Pic/{}.jpg'.format(PIC_DIR, match, encoding[:-4]), '{}/{}/{}.jpg'.format(PIC_DIR, name, encoding[:-4]))
